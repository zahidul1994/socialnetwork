    ...
    <div class="suggestions" id="sticky-sidebar">
        ...
        <hr>
            ...
            <div class="follow-user">
                ...
                <div>
                    <h6><a href="timeline.html">friend request name</a></h6>
                    <a class="confirmBtn text-green" data-uid="" href="javascript:void(0)">Confirm</a>
                    <a class="deleteBtn text-danger" data-uid="" href="javascript:void(0)">Delete</a>
                </div>
            </div>
