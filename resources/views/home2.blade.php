            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav float-right list-inline list-unstyled main-menu">
                    <li class="nav-item list-inline-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Home <span><img src="images/down-arrow.png" alt="" /></span></a>
                        <ul class="dropdown-menu list-inline list-unstyled newsfeed-home">
                            <li><a href="index.html" class="nav-link">Landing Page 1</a></li>
                            <li><a href="index-register.html" class="nav-link">Landing Page 2</a></li>
                        </ul>
                    </li>
                    <li class="nav-item list-inline-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Newsfeed <span><img src="images/down-arrow.png" alt="" /></span></a>
                        <ul class="dropdown-menu list-inline list-unstyled newsfeed-home">
                    ...
                    <li class="nav-item list-inline-item dropdown">
                        ...
                        <ul class="dropdown-menu list-inline list-unstyled login">
                            ...
                            <li><a href="edit-profile-password.html" class="nav-link">Change Password</a></li>
                        </ul>
                    </li>
                    <li class="nav-item list-inline-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle pages" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">All Pages <span><img src="images/down-arrow.png" alt="" /></span></a>
                        <ul class="dropdown-menu list-inline list-unstyled">
                            ...
                            <li><a href="timeline-album.html" class="nav-link">Timeline Album</a></li>
                            <li><a href="timeline-friends.html" class="nav-link">Timeline Friends</a></li>
                            <li><a href="edit-profile-basic.html" class="nav-link">Edit Profile</a></li>
                ...
                <form class="navbar-form hidden-sm float-left">
                        ...
                        <div class="col-md-7 col-sm-7">
                            ...
                            <div class="form-group">
                                <label for="post-images" title="Upload Images">
                                    <img src="{{asset("images/Image_upload_32.png")}}"/>
                                </label>
                    ...
                    <div class="post-container">
                        ...
                        <div class="post-detail">
                            ...
                            <div class="reaction">
                                ...
                                <a class="btn text-success"><i class="icon ion-thumbsup"></i> 13</a>
    ...
    $(document).ready(function(e){
        ...
        $(document).on('change','#post-images',function(){
            ...
            for (var i = 0; i < len_files; i++) {
                ...
                var construc = '<div class="d-inline"><img width="120px" height="120px" src="' +  window.URL.createObjectURL(file_data) + '" alt="'  +  file_data.name  + '" /></div>';
